...
/**
 * Class: RestClient date: 2017年8月3日 下午9:37:52
 * 
 * @author chenxihong
 * @version
 * @since JDK 1.8
...
public class RestClient {
    ...
    // public String show() {
    // return template.getForObject(url + "show.do", String.class, new
    // String[]{});
    // }
    ...
    public String addUser(String user) {
        return template.postForObject(url + "add.do?user={user}", null,
                String.class, user);
    }
